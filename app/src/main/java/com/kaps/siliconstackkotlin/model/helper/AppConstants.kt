package com.kaps.siliconstackkotlin.model.helper
...
import com.kaps.siliconstackkotlin.BuildConfig
...
object AppConstants {
    ...
    object Keys {
        const val AUID = "com.smsipl.emme.auid"
        const val RESPONSE = "com.smsipl.emme.response"
        const val NEED_PASSWORD_CHANGE = "needPasswordChange"
        const val IMAGE_INDIVIDUAL = "local_image_individual"
        var LANGUAGE = "com.smsipl.emme.language"
        var SELECTED_LANGUAGE = "com.smsipl.emme.selected_language"
        var LOGIN_STATUS = "com.smsipl.emme.login_status"
        var Image = "local_image"
    }
    ...
    fun showProgressDialog(context: Context) {
        if (context as Activity != null && !context.isFinishing) {
            try {
